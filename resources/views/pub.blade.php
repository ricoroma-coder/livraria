...
<div class="row w-100 m-0 mt-4 pb-4 navHidden">
    ...
    @component('components.hall', ['content' => [['name'=> 'Machado de Assis', 'sales' => 100],['name'=> 'Eça de Queiroz', 'sales' => 200],['name'=> 'Henrique Roma', 'sales' => 300]], 'title' => 'Editoras'])
    @endcomponent
...
<div class="row m-0 p-0 w-100 h-auto inData mt-4 mb-4">
    ...
    <p class="title">Todas editoras</p>
