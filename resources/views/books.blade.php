...
<div class="row w-100 m-0 mt-4 pb-4 navHidden">
    ...
    @component('components.hall', ['content' => [['name'=> 'Machado de Assis', 'sales' => 100],['name'=> 'Eça de Queiroz', 'sales' => 200],['name'=> 'Henrique Roma', 'sales' => 300]], 'title' => 'Livros'])
    @endcomponent
...
<div class="row m-0 p-0 w-100 h-auto navHidden">
    ...
    @component('components.rank', ['content' => [['name'=> 'Saraiva', 'books' => 200, 'rate' => 1],['name'=> 'Autografia', 'books' => 200, 'rate' => 2],['name'=> 'HarperCollins', 'books' => 200, 'rate' => 3],['name'=> 'Henrique Roma', 'books' => 200, 'rate' => 4]], 'title' => 'Livros'])
    @endcomponent
