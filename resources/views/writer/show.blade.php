...
@section('title', 'Escritor '.$content['obj']->name)
@section('content')
...
<div id="screen" class="close ml-auto">
    ...
    <div id="dash-body">
        <p class="title mt-4">Perfil do escritor {{ $content['obj']->name }}</p>
                ...
                <div class="row m-0 col-md-12 h-auto">
                    ...
                    <div class="row m-0 col-md-6">
                        ...
                        <div class="row col-md-12 m-0 mt-1">
                            <h3 class="badge badge-primary cursor-default">Data de nascimento</h3>
                        </div>

                        <div class="row col-md-12 m-0">
                            <input class="pt-2 pl-2 pr-2 pb-1 w-100 border-bottom border-primary bg-transparent rounded input-show cursor-default text-dark" value="{{ (!empty($content['obj']->birth)) ? implode('/', array_reverse(explode('-',$content['obj']->birth))) : 'Não registrado' }}" disabled>
                        </div>

                        <div class="row col-md-12 m-0 mt-1">
                            <h3 class="badge badge-primary cursor-default">Data do óbito</h3>
                        </div>

                        <div class="row col-md-12 m-0">
                            <input class="pt-2 pl-2 pr-2 pb-1 w-100 border-bottom border-primary bg-transparent rounded input-show cursor-default text-dark" value="{{ (!empty($content['obj']->death)) ? implode('/', array_reverse(explode('-',$content['obj']->death))) : 'Autor ainda vivo' }}" disabled>
                        </div>
                        ...
                        <div class="row col-md-12 m-0">
                            ...
                            <div class="row m-0 h-auto col-md-12">
                                ...
                                <div class="col-sm m-0 p-0">
                                    ...
                                    <form action="{{ route('writerRating', $content['obj']->id) }}" class="rate-form" method="post">
                ...
                @if (!empty($content['books']))
                    ...
                    <div class="row m-0 col-md-12 mt-5">
                        ...
                        <div class="row m-0 col-md-12">
                            <p class="title">Livros desse autor</p>
                        </div>
                                        ...
                                        <div class="card-body h-50">
                                            <div class="h-100">
                                                ...
                                                <div class="row m-0 h-50">
                                                        ...
                                                        <div class="m-0 m-1 w-100 overflow-hidden mh-100 position-relative">
                                                            ...
                                                            <div class="position-absolute" style="bottom:0;right:0;">
                                                                <a href="{{ route('dashBooks.show', $value->id) }}" class="btn btn-sm border border-dark bg-light">Leia mais...</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row m-0 pt-auto h-25 w-100">
                                                    ...
                                                    <div class="row m-0 w-100">
                                                        <a href="{{ route('dashBooks.show', $value->id) }}" class="btn btn-primary btn-sm h-auto mt-auto ml-auto">Acessar</a>
